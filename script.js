$(document).ready(function() {
	...
	const jazzQuotes = [{author: "John Coltrane", text: "The emotional reaction is all that matters."},
	...
	const arrayLength = quotesArray.length;
	$("#quote-box").append('<p id="text">' + quotesArray[Math.floor(Math.random() * arrayLength)].text + '</p>')
	$("button").click(()=> $("#text").empty().text(quotesArray[Math.floor(Math.random() * arrayLength)].text))
})